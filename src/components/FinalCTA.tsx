...
export default function FinalCTA() {
  return (
    <section id="contact" className="py-32 px-6">
      <div className="max-w-4xl mx-auto text-center bg-linear-to-b from-[#111] to-[#050505] border border-white/10 rounded-[2rem] md:rounded-[3rem] p-6 py-16 md:p-24 relative overflow-hidden">
        {/* Glow effect */}
        ...
        <div className="relative z-10">
          <Link
            ...
            className="inline-block coloredButton px-6 md:px-12 py-3.5 md:py-5 rounded-full text-base md:text-lg font-bold hover:scale-105 shadow-xl shadow-blue-900/40 whitespace-nowrap"
          >
            Schedule a Strategy Call
          </Link>
          <p className="mt-6 text-xs md:text-sm text-gray-500 uppercase tracking-wider md:tracking-widest font-semibold mb-8">
